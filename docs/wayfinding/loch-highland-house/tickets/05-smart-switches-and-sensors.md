...
A SuperLink, door sensors, and a motion sensor are ordered for the first trial. The immediate acceptance question is whether their Home Assistant integration is reliable and responsive enough for the intended automations.
