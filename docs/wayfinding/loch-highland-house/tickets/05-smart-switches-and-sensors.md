...
The SuperLink Gateway is adopted into Protect through a declared Bunker PoE switch port. Front Door and Basement Door entry sensors are adopted and exposed to Home Assistant beside their corresponding locks; the motion sensor still needs placement and naming. The immediate acceptance question is whether their Home Assistant integration is reliable and responsive enough for the intended automations.
