...
6. Disable unused overlays and features, including ZeroTier, NetBird, exit-node mode, microphone, mouse jiggler, and writable virtual media. Keep subnet routing limited to the four approved emergency networks. Remove uploaded ISO and shared files after use.
