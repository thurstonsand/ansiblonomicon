...
Closed 2026-08-19: overtaken by events. The pod042 VM is retired by the bunker-rebuild effort; the Debian host itself takes the pod042 name and the agent platform is redesigned on incus (bunker-rebuild ticket 07).
