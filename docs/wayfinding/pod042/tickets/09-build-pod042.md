...
- 2026-07-25: First boot exposed a real address collision: UniFi had `.91` statically reserved to Apple device `F0:B3:EC:23:2A:25`. Pod042 was stopped immediately. Thurston selected `.94`, verified silent and absent from static leases, with a new reservation for pod042's `02:D3:B5:97:4F:0F`; the image will be cleanly re-imported before retrying cloud-init.
