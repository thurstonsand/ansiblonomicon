...
This verifies real Amp tools, independent conversation history, warm cache reads and continuation after a graceful dedicated-container restart. It does not test hard-kill/crash recovery, UI fork/compaction, or independently measure multi-minute silent-stream heartbeats and disconnect cancellation. The deployed service and Amp route remain in place; no debug logging was enabled.
