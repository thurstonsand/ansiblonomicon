...
The existing personal Amp custom-URL connection `03c857f2-bc2f-4f8c-a0cc-d2b29042c71e` is named `Doppelclaude`, active, with `https://doppelclaude.thurstons.house/v1`, `anthropic-messages` and mapping `doppelclaude/*`. Its key was replaced through stdin; other providers were left unchanged. A controlled restart of only `doppelclaude-doppelclaude-1` must wait until the active test turn finishes.
