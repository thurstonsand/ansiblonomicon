...
- **Host**: A machine this repo configures through a native mise bootstrap target under `bootstrap/targets/`.
...
- **Tag**: A selector for partial laptop reconciliation. Each tag selects a native capability or one of its sections.
