...
console.log("");
console.log(
  "Run with: npm --prefix bootstrap/capabilities/agent-harness/configuration/assets/pi/extensions run preview:gauge:colors -- --percent 64 --theme gruvbox-light-hard [--all]",
);
