...
console.log("");
console.log(
  "Run with: npm --prefix bootstrap/capabilities/agent-harness/configuration/assets/pi/extensions run preview:gauge:shapes -- --percent 64 --verbosity high --theme gruvbox-light-hard",
);
