...
def main(args: list[str]) -> None:
    ...
    os.environ.pop("HOMEBREW_ANSIBLONOMICON_EXEC_PROFILE", None)
    os.environ.pop("HOMEBREW_ANSIBLONOMICON_EXEC_KEYS", None)
    os.environ.pop("HOMEBREW_ANSIBLONOMICON_EXEC_PYTHON", None)
